...
if (config.challenge) {
  console.log('Password protection is enabled. Usernames are:educationalhelp ' + Object.keys(config.users))
  console.log('Passwords are:lightspeedproxy' + Object.values(config.users))
